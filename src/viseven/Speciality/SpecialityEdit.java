...
public class SpecialityEdit {
  ...
  @Test
  public void testSpecialityEdit() throws Exception {
    ...
    driver.findElement(By.id("tileSpecialityModule")).click();
    ...
    driver.findElement(By.id("IsPharmaceutical")).click();
    try {
    	Thread.sleep(2000);
    } catch (InterruptedException x) {
    }
