package viseven.CategoryOfOrganization;
...
public class CategoryOfOrganizationEdit {
  ...
  @Test
  public void testCategoryOfOrganizationEdit() throws Exception {
    ...
    driver.findElement(By.id("tileCategoryOfOrganizationModule")).click();
    ...
    driver.findElement(By.id("Name")).sendKeys("autotest1");
