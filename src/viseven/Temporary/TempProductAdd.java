...
public class TempProductAdd {
	...
	@Test
	public void testTempProductAdd() throws Exception {
		try {
			...
			driver.findElement(By.cssSelector("label.input-control.checkbox > span.helper")).click();
