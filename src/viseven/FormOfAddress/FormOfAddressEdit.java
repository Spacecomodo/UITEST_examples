...
public class FormOfAddressEdit {
  ...
  @Test
  public void testFormOfAddressEdit() throws Exception {
    ...
    driver.findElement(By.id("tileFormOfAddressModule")).click();
