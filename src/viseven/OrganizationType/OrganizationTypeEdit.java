package viseven.OrganizationType;
...
public class OrganizationTypeEdit {
  ...
  @Test
  public void testOrganizationTypeEdit() throws Exception {
    ...
    driver.findElement(By.id("tileOrganizationTypeModule")).click();
