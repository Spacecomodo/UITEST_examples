...
public class MarketingCycleProductScenarioAdd {
  ...
  @Test
  public void testMarketingCycleProductScenarioAdd () throws Exception {
    ...
    driver.findElement(By.id("Scenario")).click();
    driver.findElement(By.id("Scenario")).clear();
    driver.findElement(By.id("Scenario")).sendKeys("autotest");
