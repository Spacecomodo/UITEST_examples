...
public class WorkplaceEdit {
  ...
  @Test
  public void testWorkplaceEdit() throws Exception {
        ...
        driver.findElement(By.id("gridSearchKey")).sendKeys("AutoName");
        driver.findElement(By.id("gridSearchKey")).submit();
        try {
    	Thread.sleep(2000);
        } catch (InterruptedException x) {
        }
        driver.findElement(By.partialLinkText("WP-")).click();
        driver.findElement(By.linkText("Изменить")).click();
        driver.findElement(By.id("IsMainAddress")).click();
