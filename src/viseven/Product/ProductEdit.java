...
public class ProductEdit {
	...
	public void testProductEdit() throws Exception {
		try {
			...
			Thread.sleep(2000);
			driver.findElement(By.id("tileProductModule")).click();
			...
			Thread.sleep(2000);
			driver.findElement(By.id("IsSample")).click();
			Thread.sleep(2000);
			driver.findElement(By.id("IsBatchRequired")).click();
