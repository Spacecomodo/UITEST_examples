...
public class UserEventsEdit {
  ...
  @Test
  public void testUserEventsEdit () throws Exception {
    ...
    searchHelper.findByCssAndLinkText("a[href*=\"UserEvent\"]", "autotest").click();
    driver.findElement(By.linkText("Изменить")).click();
    driver.findElement(By.id("Location")).clear();
    driver.findElement(By.id("Location")).sendKeys("Zhitomir");
