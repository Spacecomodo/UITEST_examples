...
public class TerritoryOrganizationAssigne {
	...
	@Test
	public void testTerritoryOrganizationAssigne() throws Exception {
		try {
		    ...
		    Thread.sleep(2000);
		    driver.findElement(By.id("assignButton_Organization")).click();
		    Thread.sleep(2000);
