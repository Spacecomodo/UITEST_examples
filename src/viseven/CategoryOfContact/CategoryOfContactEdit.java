package viseven.CategoryOfContact;
...
public class CategoryOfContactEdit {
  ...
  @Test
  public void testCategoryOfContactEdit() throws Exception {
    ...
    driver.findElement(By.id("tileCategoryOfContactModule")).click();
