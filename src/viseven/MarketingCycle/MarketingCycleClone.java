...
public class MarketingCycleClone {
  ...
  @Test
  public void testMarketingCycleClone() throws Exception {
    ...
    driver.findElement(By.id("Name")).sendKeys("autotest2");
    driver.findElement(By.id("StartDate")).click();
    driver.findElement(By.id("StartDate")).clear();
    driver.findElement(By.id("StartDate")).sendKeys("05.05.2015");
    driver.findElement(By.id("EndDate")).click();		    
    driver.findElement(By.id("EndDate")).clear();
    driver.findElement(By.id("EndDate")).sendKeys("06.06.2015");
