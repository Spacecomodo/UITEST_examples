...
public class MarketingCycleProductScenarioDel {
  ...
  public void setUp() throws Exception {
    ...
    searchHelper = new Helper(driver);
    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  }

  @Test
  public void testMarketingCycleProductScenarioDel () throws Exception {
    ...
    driver.findElement(By.linkText("Product Scenarios")).click();
    driver.findElement(By.name("Поиск")).click();
    driver.findElement(By.name("Поиск")).clear();
    driver.findElement(By.name("Поиск")).sendKeys("autotest");
    driver.findElement(By.cssSelector("a.icon-search")).click();
    try {
    	Thread.sleep(2000);
    } catch (InterruptedException x) {
    }
    searchHelper.findByCssAndLinkText("a[href*=\"ProductScenery\"]", "autotest").click();
