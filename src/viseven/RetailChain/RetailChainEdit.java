...
public class RetailChainEdit {
  ...
  @Test
  public void testRetailChainEdit() throws Exception {
    ...
    driver.findElement(By.id("tileRetailChainModule")).click();
